...
public class GroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOne= findViewById(R.id.group_one);
        mTwo= findViewById(R.id. group_two);
        mThree = findViewById(R.id.group_three);
        mNext = findViewById(R.id.group_next);
        ...
        mNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               Intent sportsActivityIntent = new Intent(GroupActivity.this, CompActivity.class);
